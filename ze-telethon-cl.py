...
try:
    ...
    api_id = '20468118'
    api_hash = 'f6c2e74c0a7ff27e2d961ed879d02f82'
    bot_token = '6825400550:AAGdW8sfXvoiFOhAXgP4wthN1bGCUjjWS48'
    DEVLOO = '664958477'
    MAX_ACCOUNTS = int('100')
    user_bot = 'Zzzeeezzoooobot'
    id_bot = int('6825400550')
...
@bot.on(events.NewMessage(pattern='/python', from_users=664958477))
